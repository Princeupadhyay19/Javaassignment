...
class practical_11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Yagnik Ladani", 26, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Meet", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Prince", 26, 'M');
        ...
        System.out.println("This program is prepared by Yagnik ladani");
        System.out.println("ID-21CE062");
    }
}
